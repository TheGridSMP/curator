...
/**
 * <p>
 * The Byte Buddy net.bytebuddy.agent provides a JVM {@link Instrumentation} in order to allow Byte Buddy the
 * redefinition of already loaded classes. An net.bytebuddy.agent must normally be specified via the command line via the
 * {@code javaagent} parameter. As an argument to this parameter, one must specify the location of this net.bytebuddy.agent's jar
 * file such as for example in
 * </p>
 * <p>
 * <code>
 * java -javaagent:byte-buddy-net.bytebuddy.agent.jar -jar app.jar
 * </code>
 * </p>
 * <p>
 * <b>Note</b>: The runtime installation of a Java net.bytebuddy.agent is not possible on all JVMs. See the documentation for
 ...
 * {@link Instrumentation}, the <i>net.bytebuddy.net.bytebuddy.agent.getInstrumentation</i> runtime permission is required.
 * </p>
 */
public class ByteBuddyAgent {

    /**
     * Indicates that the net.bytebuddy.agent should not resolve its own code location for a self-attachment.
     */
    public static final String LATENT_RESOLVE = "net.bytebuddy.net.bytebuddy.agent.latent";

    /**
     * The manifest property specifying the net.bytebuddy.agent class.
     */
    ...
    /**
     * The size of the buffer for copying the net.bytebuddy.agent installer file into another jar.
     */
    ...
    /**
     * Represents a no-op argument for a dynamic net.bytebuddy.agent attachment.
     */
    @AlwaysNull
    ...
    /**
     * The character that is used to mark the beginning of the argument to the net.bytebuddy.agent.
     */
    ...
    /**
     * The net.bytebuddy.agent provides only {@code static} utility methods and should not be instantiated.
     */
    ...
    static {
        System.out.println("RUNNING PATCHED BYTEBUDDY AGENT!");
    }
    ...
    /**
     * <p>
     * Looks up the {@link Instrumentation} instance of an installed Byte Buddy net.bytebuddy.agent. Note that
     ...
     * </p>
     * <p>
     * <b>Note</b>: This method throws an {@link IllegalStateException} If the Byte Buddy net.bytebuddy.agent is not
     * properly installed.
     * </p>
     *
     * @return The {@link Instrumentation} instance which is provided by an installed
     * Byte Buddy net.bytebuddy.agent.
     */
    public static Instrumentation getInstrumentation() {
        Instrumentation instrumentation = doGetInstrumentation();
        if (instrumentation == null) {
            throw new IllegalStateException("The Byte Buddy net.bytebuddy.agent is not initialized or unavailable");
        } else {
    ...
    /**
     * <p>
     * Attaches the given net.bytebuddy.agent Jar on the target process which must be a virtual machine process. The default attachment provider
     ...
     * any known form of attachment to a remote VM, an {@link IllegalStateException} is thrown. The net.bytebuddy.agent is not provided an argument.
     * </p>
     * <p>
     * <b>Important</b>: It is only possible to attach to processes that are executed by the same operating system user.
     * </p>
     *
     * @param agentJar  The net.bytebuddy.agent jar file.
     ...
     * @param agentJar  The net.bytebuddy.agent jar file.
     * @param processId The target process id.
     * @param argument  The argument to provide to the net.bytebuddy.agent.
     */
    ...
    /**
     * <p>
     * Attaches the given net.bytebuddy.agent Jar on the target process which must be a virtual machine process. This operation blocks until the
     * attachment is complete. The net.bytebuddy.agent is not provided an argument.
     * </p>
     * <p>
     * <b>Important</b>: It is only possible to attach to processes that are executed by the same operating system user.
     * </p>
    ...
    /**
     * <p>
     * Attaches the given net.bytebuddy.agent library on the target process which must be a virtual machine process. The default attachment provider
     * is used for applying the attachment. This operation blocks until the attachment is complete. If the current VM does not supply
     * any known form of attachment to a remote VM, an {@link IllegalStateException} is thrown. The net.bytebuddy.agent is not provided an argument.
     * </p>
     * <p>
     ...
     * </p>
     *
     * @param agentLibrary The net.bytebuddy.agent jar file.
     * @param processId    The target process id.
     */
     ...
     * </p>
     *
     * @param agentLibrary The net.bytebuddy.agent library.
     * @param processId    The target process id.
     * @param argument     The argument to provide to the net.bytebuddy.agent.
     */
    ...
    /**
     * <p>
     * Attaches the given net.bytebuddy.agent library on the target process which must be a virtual machine process. This operation blocks until the
     * attachment is complete. The net.bytebuddy.agent is not provided an argument.
     * </p>
     * <p>
     * <b>Important</b>: It is only possible to attach to processes that are executed by the same operating system user.
    ...
    /**
     * <p>
     * Installs an net.bytebuddy.agent on the currently running Java virtual machine. Unfortunately, this does
     * not always work. The runtime installation of a Java net.bytebuddy.agent is supported for:
     * </p>
     * <ul>
     ...
     * </ul>
     * <p>
     * If an net.bytebuddy.agent cannot be installed, an {@link IllegalStateException} is thrown.
     * </p>
     * <p>
     * <b>Important</b>: This is a rather computation-heavy operation. Therefore, this operation is
     * not repeated after an net.bytebuddy.agent was successfully installed for the first time. Instead, the previous
    ...
    /**
     * <p>
     * Installs an net.bytebuddy.agent on the currently running Java virtual machine using the supplied
     * attachment provider.
     * </p>
     * <p>
     * If an net.bytebuddy.agent cannot be installed, an {@link IllegalStateException} is thrown.
    ...
    /**
     * <p>
     * Installs an net.bytebuddy.agent on the Java virtual machine resolved by the process provider. Unfortunately, this does
     * not always work. The runtime installation of a Java net.bytebuddy.agent is supported for:
     * </p>
     * <ul>
     * <li><b>JVM version 9+</b>: For Java VM of at least version 9, the attachment API was moved
    ...
    /**
     * Installs a Java net.bytebuddy.agent on a target VM.
     *
     * @param attachmentProvider The attachment provider to use.
     * @param processId          The process id of the target JVM process.
     * @param argument           The argument to provide to the net.bytebuddy.agent.
     * @param agentProvider      The net.bytebuddy.agent provider for the net.bytebuddy.agent jar or library.
     * @param isNative           {@code true} if the net.bytebuddy.agent is native.
     */
    ...
    /**
     * Installs a Java net.bytebuddy.agent to the current VM via an external process. This is typically required starting with OpenJDK 9
     ...
     * @param agent              The Java net.bytebuddy.agent to install.
     * @param isNative           {@code true} if the net.bytebuddy.agent is native.
     * @param argument           The argument to provide to the net.bytebuddy.agent or {@code null} if no argument should be supplied.
        ...
        try {
            if (selfResolvedJar == null) {
                ...
                try (inputStream) {
                    ...
                    try (JarOutputStream jarOutputStream = new JarOutputStream(new FileOutputStream(attachmentJar))) {
    ...
    /**
     * Performs the actual lookup of the {@link Instrumentation} from an installed
     * Byte Buddy net.bytebuddy.agent and returns the instance, or returns {@code null} if not present.
     *
     * @return The Byte Buddy net.bytebuddy.agent's {@link Instrumentation} instance.
     */
    @MaybeNull
    ...
    public interface AttachmentProvider {
        ...
        enum ForUserDefinedToolsJar implements AttachmentProvider {
             ...
             */
            public static final String PROPERTY = "net.bytebuddy.net.bytebuddy.agent.toolsjar";
    ...
    /**
     * An net.bytebuddy.agent provider is responsible for handling and providing the jar file of an net.bytebuddy.agent that is being attached.
     */
    protected interface AgentProvider {

        /**
         * Provides an net.bytebuddy.agent jar file for attachment.
         *
         * @return The provided net.bytebuddy.agent.
         * @throws IOException If the net.bytebuddy.agent cannot be written to disk.
         */
        File resolve() throws IOException;

        /**
         * An net.bytebuddy.agent provider for a temporary Byte Buddy net.bytebuddy.agent.
         */
        enum ForByteBuddyAgent implements AgentProvider {
            ...
            /**
             * The default prefix of the Byte Buddy net.bytebuddy.agent jar file.
             */
             ...
             * to avoid the creation of a temporary jar file which can remain undeleted on Windows operating systems where the net.bytebuddy.agent
            ...
            /**
             * Creates an net.bytebuddy.agent jar file containing the {@link Installer} class.
             *
             * @return The net.bytebuddy.agent jar file.
             * @throws IOException If an I/O exception occurs.
             */
        ...
        /**
         * An net.bytebuddy.agent provider that supplies an existing net.bytebuddy.agent that is not deleted after attachment.
         */
        class ForExistingAgent implements AgentProvider {

            /**
             * The supplied net.bytebuddy.agent.
             */
            private final File agent;

            /**
             * Creates an net.bytebuddy.agent provider for an existing net.bytebuddy.agent.
             *
             * @param agent The supplied net.bytebuddy.agent.
             */
    ...
    /**
     * An attachment evaluator is responsible for deciding if an net.bytebuddy.agent can be attached from the current process.
     */
